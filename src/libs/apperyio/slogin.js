    ...
    function loginOauth1_0a( dbId, clientId, baseUrl, callbackUrl, socialnetwork ) {
        ...
        function getVerifier( event ) {
            ...
            if ( params[ 'oauth_token' ] && params[ 'oauth_verifier' ] ) {
                externalLogin( deferred, params[ 'oauth_verifier' ], params[ 'oauth_token' ], dbId, clientId,
                    socialnetwork );
                ref.close();
            } else {
                deferred.reject( "Access not granted" );
        ...
        var LoginClass = function() {
            ...
            return {
                ...
                updateUser: function( options, dbId ) {
                    var updateUserRest = initREST( REST, updateUserUrl.replace( "<user_id>", this.getUserId(
                        dbId ) ), "put" );
                ...
                logoutOauth: function( provider, dbId ) {
                    var unlinkRest = initREST( REST, oauthLogout.replace( "<provider>", provider ),
                        "delete" );
                ...
                loginTwitter: function( clientId, callbackUrl, dbId ) {
                    return loginOauth1_0a( dbId, clientId, providers.twitter.baseUrl, callbackUrl,
                ...
                loginFB: function( clientId, callbackUrl, dbId ) {
                    return loginOauth2_0( dbId, clientId, providers.facebook.baseUrl, callbackUrl,
                ...
                loginGoogle: function( clientId, callbackUrl, dbId ) {
                    return loginOauth2_0( dbId, clientId, providers.google.baseUrl, callbackUrl,
